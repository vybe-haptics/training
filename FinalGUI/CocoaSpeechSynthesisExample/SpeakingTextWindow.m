...
- (void)AssignTestButtons:(NSString *)Level {
    ...
    if([Level  isEqual: @"2"]){
        phonemesToTest = [[NSMutableArray alloc]initWithObjects: @"AX", @"d", @"IH", @"IY",@"n",@"r",@"s", @"t", @"IX", @"l", @"m", @"AY", nil];}
    if([Level  isEqual: @"3"]){
        phonemesToTest = [[NSMutableArray alloc]initWithObjects: @"AX", @"d", @"IH", @"IY",@"n",@"r",@"s", @"t", @"IX", @"l", @"m", @"AY", @"z", @"EH", @"UX", @"k", nil];}
    if([Level  isEqual: @"4"]){
        phonemesToTest = [[NSMutableArray alloc]initWithObjects: @"AX", @"d", @"IH", @"IY",@"n",@"r",@"s", @"t", @"IX", @"l", @"m", @"AY", @"z", @"EH", @"UX", @"k",@"AE", @"w", @"D", @"h", nil];}
    if([Level  isEqual: @"5"]){
        phonemesToTest = [[NSMutableArray alloc]initWithObjects: @"AX", @"d", @"IH", @"IY",@"n",@"r",@"s", @"t", @"IX", @"l", @"m", @"AY", @"z", @"EH", @"UX", @"k",@"AE", @"w", @"D", @"h", @"AO", @"AA", @"v", @"p", nil];}
    if([Level  isEqual: @"6"]){
        phonemesToTest = [[NSMutableArray alloc]initWithObjects: @"AX", @"d", @"IH", @"IY",@"n",@"r",@"s", @"t", @"IX", @"l", @"m", @"AY", @"z", @"EH", @"UX", @"k",@"AE", @"w", @"D", @"h", @"AO", @"AA", @"v", @"p", @"UW", @"f", @"b", @"OW", nil];}
    if([Level  isEqual: @"7"]){
        phonemesToTest = [[NSMutableArray alloc]initWithObjects: @"AX", @"d", @"IH", @"IY",@"n",@"r",@"s", @"t", @"IX", @"l", @"m", @"AY", @"z", @"EH", @"UX", @"k",@"AE", @"w", @"D", @"h", @"AO", @"AA", @"v", @"p", @"UW", @"f", @"b", @"OW", @"EY", @"N", @"S", @"AW", nil];}
    if([Level  isEqual: @"8"]){
    ...
    [phonemesAlreadyTested addObject: phonemeBeingTested];
    testButtons = [NSMutableDictionary dictionaryWithDictionary:@{}];
    //NSLog(@"level size is %d", levelsize);
    //NSLog(@"phonemestotest is %@", phonemesToTest);
    
    [phonemesToTest removeObject: phonemeBeingTested];
    for ( int i = 0; i < 8; i++){
        levelsize = [phonemesToTest count];
        if (i == correctButton){
            testButtons[[NSString stringWithFormat:@"%i", correctButton+1]] = phonemeBeingTested;
        }
        else {
            wrongPhoneme = phonemesToTest[arc4random_uniform(levelsize)];
            [phonemesToTest removeObject: wrongPhoneme];
            testButtons[[NSString stringWithFormat:@"%i", i+1]] = wrongPhoneme;
        }
