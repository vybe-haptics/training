...
- (void)setExpressionForPhoneme:(NSNumber *)phoneme {
    ...
    if (phonemeValue == 5){
        SetSpeechProperty(fCurSpeechChannel, kSpeechVolumeProperty,(__bridge CFTypeRef)(@(0.0)));
        NSLog(@"silenced %d", phonemeValue);}
    else{
        SetSpeechProperty(fCurSpeechChannel, kSpeechVolumeProperty, (__bridge CFTypeRef)(@(0.0)));
        NSLog(@"NOT %d", phonemeValue);}}

    
    
    //int pr = arc4random_uniform(10);
