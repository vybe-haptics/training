...
- (void)speechIsDone2 {
    ...
    if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level1nums]]){
        ...
        NSString *filepath = @"/Users/shakkedhalperin/Desktop/1.txt";
        ...
        [TrialWordPhons removeAllObjects];
        NSString *filepath = @"/Users/shakkedhalperin/Desktop/2.txt";
        NSString *contents = [NSString stringWithContentsOfFile:filepath];
        contents = [contents stringByAppendingString:WordToAdd];
        [contents writeToFile:filepath
                   atomically:YES
        ...
        [TrialWordPhons removeAllObjects];
        NSString *filepath = @"/Users/shakkedhalperin/Desktop/3.txt";
        NSString *contents = [NSString stringWithContentsOfFile:filepath];
        contents = [contents stringByAppendingString:WordToAdd];
        [contents writeToFile:filepath
                   atomically:YES
        ...
        [TrialWordPhons removeAllObjects];
        NSString *filepath = @"/Users/shakkedhalperin/Desktop/4.txt";
        NSString *contents = [NSString stringWithContentsOfFile:filepath];
        contents = [contents stringByAppendingString:WordToAdd];
        [contents writeToFile:filepath
                   atomically:YES
        ...
        [TrialWordPhons removeAllObjects];
        NSString *filepath = @"/Users/shakkedhalperin/Desktop/5.txt";
        NSString *contents = [NSString stringWithContentsOfFile:filepath];
        contents = [contents stringByAppendingString:WordToAdd];
        [contents writeToFile:filepath
                   atomically:YES
        ...
        [TrialWordPhons removeAllObjects];
        NSString *filepath = @"/Users/shakkedhalperin/Desktop/6.txt";
        NSString *contents = [NSString stringWithContentsOfFile:filepath];
        contents = [contents stringByAppendingString:WordToAdd];
        [contents writeToFile:filepath
                   atomically:YES
        ...
        [TrialWordPhons removeAllObjects];
        NSString *filepath = @"/Users/shakkedhalperin/Desktop/7.txt";
        NSString *contents = [NSString stringWithContentsOfFile:filepath];
        contents = [contents stringByAppendingString:WordToAdd];
        [contents writeToFile:filepath
                   atomically:YES
        ...
        [TrialWordPhons removeAllObjects];
        NSString *filepath = @"/Users/shakkedhalperin/Desktop/8.txt";
        NSString *contents = [NSString stringWithContentsOfFile:filepath];
        contents = [contents stringByAppendingString:WordToAdd];
        [contents writeToFile:filepath
                   atomically:YES
        ...
        [TrialWordPhons removeAllObjects];
        NSString *filepath = @"/Users/shakkedhalperin/Desktop/9.txt";
        NSString *contents = [NSString stringWithContentsOfFile:filepath];
        contents = [contents stringByAppendingString:WordToAdd];
        [contents writeToFile:filepath
                   atomically:YES
        ...
        [TrialWordPhons removeAllObjects];
        NSString *filepath = @"/Users/shakkedhalperin/Desktop/unsorted.txt";
        NSString *contents = [NSString stringWithContentsOfFile:filepath];
        contents = [contents stringByAppendingString:WordToAdd];
        [contents writeToFile:filepath
                   atomically:YES
...
- (IBAction)Vybe:(id)sender {
    ...
    [NSString stringWithContentsOfFile:@"/Users/shakkedhalperin/Desktop/VybeLog.txt"
                              encoding:NSASCIIStringEncoding
                                 error:NULL];
    NSString * path = [NSString stringWithFormat:@"/Users/shakkedhalperin/Desktop/%@%@", zStr, @".txt"];
...
//    NSString * path = [NSString stringWithFormat:@"/Users/shakkedhalperin/Desktop/%@%@", zStr, @".txt"];
//    
    AllWords = [NSString stringWithContentsOfFile:@"/Users/shakkedhalperin/Desktop/EnglishWords.txt"
                                                    encoding:NSASCIIStringEncoding
                                                       error:NULL];
...
//            NSString * WordToAdd = [NSString stringWithFormat:@"\n%@", WOI];
//            [TrialWordPhons removeAllObjects];
//            [WordToAdd writeToFile:@"/Users/shakkedhalperin/Desktop/1.txt"
//                   atomically:YES
//                     encoding:NSASCIIStringEncoding error:NULL];}
//        else if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level2nums]]){
//            
//            NSString * WordToAdd = [NSString stringWithFormat:@"\n%@", WOI];
//            [TrialWordPhons removeAllObjects];
//            [WordToAdd writeToFile:@"/Users/shakkedhalperin/Desktop/2.txt"
//                        atomically:YES
//                          encoding:NSASCIIStringEncoding error:NULL];}
//        
//        else if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level3nums]]){
...
//            NSString * WordToAdd = [NSString stringWithFormat:@"\n%@", WOI];
//            [TrialWordPhons removeAllObjects];
//            [WordToAdd writeToFile:@"/Users/shakkedhalperin/Desktop/3.txt"
//                        atomically:YES
//                          encoding:NSASCIIStringEncoding error:NULL];}
//        
//        else if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level4nums]]){
...
//            NSString * WordToAdd = [NSString stringWithFormat:@"\n%@", WOI];
//            [TrialWordPhons removeAllObjects];
//            [WordToAdd writeToFile:@"/Users/shakkedhalperin/Desktop/4.txt"
//                        atomically:YES
//                          encoding:NSASCIIStringEncoding error:NULL];}
//        
//        else if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level5nums]]){
...
//            NSString * WordToAdd = [NSString stringWithFormat:@"\n%@", WOI];
//            [TrialWordPhons removeAllObjects];
//            [WordToAdd writeToFile:@"/Users/shakkedhalperin/Desktop/5.txt"
//                        atomically:YES
//                          encoding:NSASCIIStringEncoding error:NULL];}
//        else if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level3nums]]){
//            NSLog(@"WORD HAS NO GROUP 1-5");
