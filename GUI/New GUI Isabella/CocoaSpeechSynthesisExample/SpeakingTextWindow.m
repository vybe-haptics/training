...
@interface SpeakingTextWindow ()
{
    ...
    IBOutlet NSButton *SilencingCheckboxButton;
    ...
    NSMutableArray *wordsAlreadyTested;
    NSMutableArray *TrialWordPhons;
    NSString *TestedWord;
    ...
    IBOutlet NSTextField *fcorrectAnswer;
...
static void  OurSpeechDoneCallBackProcTwo(SpeechChannel inSpeechChannel, SRefCon inRefCon);
...
static void  OurPhonemeCallBackProcNew(SpeechChannel inSpeechChannel, SRefCon inRefCon, short inPhonemeOpcode);
static void  OurPhonemeCallBackProcFour(SpeechChannel inSpeechChannel, SRefCon inRefCon, short inPhonemeOpcode);
...
static void OurWordCFCallBackProcThree(SpeechChannel inSpeechChannel, SRefCon inRefCon, CFStringRef inCFStringRef, CFRange inWordCFRange);
...
- (void)speechIsDone2 {
    ...
    NSArray *level9nums = [NSArray arrayWithObjects:@0, @5, @8, @6, @20, @29, @32, @33, @35, @10, @27, @28, @9, @40, @7, @14, @26, @2, @28, @21, @24, @4, @11, @37, @31, @12, @15, @22, @18, @3, @16, @30, @34, @13, @23, @36, @39, @17, @38, @41, nil];//19
    
    int n = [TrialWordPhons count];
    NSLog(@"number of words in phon %d", n);
    NSLog(@"WOI is %@", WOI);
    NSString * WordToAdd = [NSString stringWithFormat:@"%@\n", WOI];
    
    if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level1nums]]){

        [TrialWordPhons removeAllObjects];
        NSString *filepath = @"/Users/Isabella/Desktop/1.txt";
        NSString *contents = [NSString stringWithContentsOfFile:filepath];
        contents = [contents stringByAppendingString:WordToAdd];
        [contents writeToFile:filepath
                    atomically:YES
                      encoding:NSASCIIStringEncoding error:NULL];}
    
    else if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level2nums]]){
        
        [TrialWordPhons removeAllObjects];
        NSString *filepath = @"/Users/Isabella/Desktop/2.txt";
        NSString *contents = [NSString stringWithContentsOfFile:filepath];
        contents = [contents stringByAppendingString:WordToAdd];
        [contents writeToFile:filepath
                   atomically:YES
    ...
    else if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level3nums]]){
        
        [TrialWordPhons removeAllObjects];
        NSString *filepath = @"/Users/Isabella/Desktop/3.txt";
        NSString *contents = [NSString stringWithContentsOfFile:filepath];
        contents = [contents stringByAppendingString:WordToAdd];
        [contents writeToFile:filepath
                   atomically:YES
    ...
    else if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level4nums]]){
        
        [TrialWordPhons removeAllObjects];
        NSString *filepath = @"/Users/Isabella/Desktop/4.txt";
        NSString *contents = [NSString stringWithContentsOfFile:filepath];
        contents = [contents stringByAppendingString:WordToAdd];
        [contents writeToFile:filepath
                   atomically:YES
    ...
    else if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level5nums]]){
        
        [TrialWordPhons removeAllObjects];
        NSString *filepath = @"/Users/Isabella/Desktop/5.txt";
        NSString *contents = [NSString stringWithContentsOfFile:filepath];
        contents = [contents stringByAppendingString:WordToAdd];
        [contents writeToFile:filepath
                   atomically:YES
    ...
    else if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level6nums]]){
        
        [TrialWordPhons removeAllObjects];
        NSString *filepath = @"/Users/Isabella/Desktop/6.txt";
        NSString *contents = [NSString stringWithContentsOfFile:filepath];
        contents = [contents stringByAppendingString:WordToAdd];
        [contents writeToFile:filepath
                   atomically:YES
    ...
    else if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level7nums]]){
        
        [TrialWordPhons removeAllObjects];
        NSString *filepath = @"/Users/Isabella/Desktop/7.txt";
        NSString *contents = [NSString stringWithContentsOfFile:filepath];
        contents = [contents stringByAppendingString:WordToAdd];
        [contents writeToFile:filepath
                   atomically:YES
    ...
    else if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level8nums]]){
        
        [TrialWordPhons removeAllObjects];
        NSString *filepath = @"/Users/Isabella/Desktop/8.txt";
        NSString *contents = [NSString stringWithContentsOfFile:filepath];
        contents = [contents stringByAppendingString:WordToAdd];
        [contents writeToFile:filepath
                   atomically:YES
    ...
    else if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level9nums]]){
        
        [TrialWordPhons removeAllObjects];
        NSString *filepath = @"/Users/Isabella/Desktop/9.txt";
        NSString *contents = [NSString stringWithContentsOfFile:filepath];
        contents = [contents stringByAppendingString:WordToAdd];
        [contents writeToFile:filepath
                   atomically:YES
        ...
        [TrialWordPhons removeAllObjects];
        NSString *filepath = @"/Users/Isabella/Desktop/unsorted.txt";
        NSString *contents = [NSString stringWithContentsOfFile:filepath];
        contents = [contents stringByAppendingString:WordToAdd];
        [contents writeToFile:filepath
                   atomically:YES
...
- (void)startSpeakingTextViewToURL:(NSURL *)url {
    ...
    if (noErr == theErr) {
        theErr = SetSpeechProperty(fCurSpeechChannel, kSpeechPhonemeCallBack,
                                   (__bridge CFTypeRef)(@(fSavingToFile ? (long)NULL : (long)OurPhonemeCallBackProcThree)));
        if (noErr != theErr) {
...
- (void)awakeFromNib {
    ...
    phonemesAlreadyTested = [[NSMutableArray alloc] init];
    wordsAlreadyTested = [[NSMutableArray alloc] init];
    TrialWordPhons = [[NSMutableArray alloc] init];
    j = 0;
...
- (void)setExpressionForTextBox:(NSNumber *)phoneme {
    ...
    int silencing = 5;
    //change int silencing to increase probability of silencing
    ...
    if ([LevelSelector indexOfSelectedItem] == 9) {
        NSLog(@"silencing prob %d", silencingProb);
        if ([level9nums containsObject:@(phonemeValue)]){
            NSLog(@"level 9 phoneme %d", phonemeValue);
            write(serialFileDescriptor, (const void *) &phonemeValue, 1);
            if ([SilencingCheckboxButton state] == NSOnState && silencingProb < silencing){
...
- (void)setExpressionForTextBoxTwo:(NSNumber *)phoneme {
    
    int phonemeValue = [phoneme shortValue];
    
    NSLog(@"phoneme %d", phonemeValue);
    
    [TrialWordPhons addObject: @(phonemeValue)];
...
- (void)setExpressionForWord2:(NSNumber *)phoneme {
...
- (IBAction)Vybe:(id)sender {
    [fcorrectAnswer setStringValue:@""];
    
    textInput.stringValue = @"";
    if (![sender isKindOfClass:[NSButton class]])
        return;
    NSString * zStr =
    [NSString stringWithContentsOfFile:@"/Users/Isabella/Desktop/VybeLog.txt"
                              encoding:NSASCIIStringEncoding
                                 error:NULL];
    NSString * path = [NSString stringWithFormat:@"/Users/Isabella/Desktop/%@%@", zStr, @".txt"];
    
    NSString * AllWords = [NSString stringWithContentsOfFile:path
                                                    encoding:NSASCIIStringEncoding
                                                       error:NULL];
    
    NSArray * WordList = [AllWords componentsSeparatedByString:@"\n"];
    
    int levelsize = [WordList count];
    int random = arc4random_uniform(levelsize);
    
    TestedWord = WordList[random];
    int f = 0;
    while ([wordsAlreadyTested containsObject:TestedWord]) {
        random = arc4random_uniform(levelsize);
        TestedWord = WordList[random];
        if (f>10){
            random = arc4random_uniform(levelsize);
            TestedWord = WordList[random];
    ...
    [wordsAlreadyTested addObject: TestedWord];
    ...
    NSLog(@"hello2 %@", path);
    NSLog(TestedWord);
    [self startSpeakingWordButton2:TestedWord];}
...
//    NSString * path = [NSString stringWithFormat:@"/Users/Isabella/Desktop/%@%@", zStr, @".txt"];
//    
    AllWords = [NSString stringWithContentsOfFile:@"/Users/Isabella/Desktop/EnglishWords.txt"
                                                    encoding:NSASCIIStringEncoding
                                                       error:NULL];
    ...
    //while (j < 5){
        ...
        SetSpeechProperty(fCurSpeechChannel, kSpeechPhonemeCallBack,
                          (__bridge CFTypeRef)(@(fSavingToFile ? (long)NULL : (long)OurPhonemeCallBackProcFour)));
//        SetSpeechProperty(fCurSpeechChannel, kSpeechWordCFCallBack,
//                          (__bridge CFTypeRef)(@(fSavingToFile ? (long)NULL : (long)OurWordCFCallBackProcThree)));
        
        SetSpeechProperty(fCurSpeechChannel,
                          kSpeechSpeechDoneCallBack,
                          (__bridge CFTypeRef)(@((long)OurSpeechDoneCallBackProcTwo)));
        
        SpeakCFString(fCurSpeechChannel, (__bridge CFStringRef)WOI, NULL);
        
        
//        StopSpeechAt(fCurSpeechChannel, kEndOfWord);
...
//            NSString * WordToAdd = [NSString stringWithFormat:@"\n%@", WOI];
//            [TrialWordPhons removeAllObjects];
//            [WordToAdd writeToFile:@"/Users/Isabella/Desktop/1.txt"
//                   atomically:YES
//                     encoding:NSASCIIStringEncoding error:NULL];}
//        else if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level2nums]]){
//            
//            NSString * WordToAdd = [NSString stringWithFormat:@"\n%@", WOI];
//            [TrialWordPhons removeAllObjects];
//            [WordToAdd writeToFile:@"/Users/Isabella/Desktop/2.txt"
//                        atomically:YES
//                          encoding:NSASCIIStringEncoding error:NULL];}
//        
//        else if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level3nums]]){
...
//            NSString * WordToAdd = [NSString stringWithFormat:@"\n%@", WOI];
//            [TrialWordPhons removeAllObjects];
//            [WordToAdd writeToFile:@"/Users/Isabella/Desktop/3.txt"
//                        atomically:YES
//                          encoding:NSASCIIStringEncoding error:NULL];}
//        
//        else if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level4nums]]){
...
//            NSString * WordToAdd = [NSString stringWithFormat:@"\n%@", WOI];
//            [TrialWordPhons removeAllObjects];
//            [WordToAdd writeToFile:@"/Users/Isabella/Desktop/4.txt"
//                        atomically:YES
//                          encoding:NSASCIIStringEncoding error:NULL];}
//        
//        else if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level5nums]]){
...
//            NSString * WordToAdd = [NSString stringWithFormat:@"\n%@", WOI];
//            [TrialWordPhons removeAllObjects];
//            [WordToAdd writeToFile:@"/Users/Isabella/Desktop/5.txt"
//                        atomically:YES
//                          encoding:NSASCIIStringEncoding error:NULL];}
//        else if ([[NSSet setWithArray: TrialWordPhons] isSubsetOfSet: [NSSet setWithArray: level3nums]]){
//            NSLog(@"WORD HAS NO GROUP 1-5");
...
- (IBAction)SelectedAnswer:(id)sender {
    ...
    NSString *answer =[textInput stringValue];
    NSLog(@"answer %@", answer);
//    NSMutableCharacterSet* zeroWidthCharacterSet = [[NSCharacterSet whitespaceCharacterSet] mutableCopy];
//    [zeroWidthCharacterSet formIntersectionWithCharacterSet:[[NSCharacterSet whitespaceAndNewlineCharacterSet] invertedSet]];
//    NSString *TestedWord2 = [[TestedWord componentsSeparatedByCharactersInSet:zeroWidthCharacterSet] componentsJoinedByString:@""];
//    NSLog(@"TestedWord %@", TestedWord);
    NSString * TestedWord2 = [TestedWord substringToIndex:[TestedWord length] - 1];
    NSUInteger lenanswer = [answer length];
    NSUInteger lenTestedWord2 = [TestedWord2 length];
    NSLog(@"lenanswer is %d, lenTestedWord2 is %d", lenanswer, lenTestedWord2);
    
    if ([TestedWord2 isEqual:answer]){
        correctAnswers ++;
        ...
        wrongAnswers ++;
        NSLog(@"right word is %@ and answer %@", TestedWord, answer);
        totalAttempts = correctAnswers + wrongAnswers;
        [fLastAnswer setStringValue:@"Wrong!"];
        [fAllAnswers setStringValue:[NSString stringWithFormat: @"%d Correct / %d Attempted", correctAnswers,  totalAttempts]];
        NSString * rightWord = [NSString stringWithFormat:@"Correct answer was: %@", TestedWord2];
        [fcorrectAnswer setStringValue:rightWord];
    
    }
//        
//            wrongAnswers ++;
//            NSLog(@"its in the wrong");
//            totalAttempts = correctAnswers + wrongAnswers;
//            [fLastAnswer setStringValue:@"Wrong!"];
//            [fAllAnswers setStringValue:[NSString stringWithFormat: @"%d Correct / %d Attempted", correctAnswers,  totalAttempts]];}
        if (wrongAnswers == 3){
        ...
        if ( correctAnswers == 8 ){
            ...
            [zStr writeToFile:@"/Users/Isabella/Desktop/VybeLog.txt"
                   atomically:YES
                     encoding:NSASCIIStringEncoding error:NULL];}
    ...
    NSLog(@"attempts %d, correctAnswers %d, wrongAnswers %d", totalAttempts, correctAnswers, wrongAnswers);
                }
...
- (void)startSpeakingWordButton2:(NSString *)word {
    SetSpeechProperty(fCurSpeechChannel, kSpeechInputModeProperty, kSpeechModeText);
    SetSpeechProperty(fCurSpeechChannel, kSpeechPhonemeCallBack,
                      (__bridge CFTypeRef)(@(fSavingToFile ? (long)NULL : (long)OurPhonemeCallBackProcNew)));
    // Convert NSString to cString.
    // We want the text view the active view.  Also saves any parameters currently being edited.
    //[fWindow makeFirstResponder:fSpokenTextView];
    SetSpeechProperty(fCurSpeechChannel,
...
static void OurSpeechDoneCallBackProcTwo(SpeechChannel inSpeechChannel, SRefCon inRefCon) {
    @autoreleasepool {
        NSLog(@"is it?");
        SpeakingTextWindow *stw = (__bridge SpeakingTextWindow *)inRefCon;
        [stw performSelectorOnMainThread:@selector(speechIsDone2)
                              withObject:NULL
                           waitUntilDone:NO];
    }}
...
static void OurPhonemeCallBackProcNew(SpeechChannel inSpeechChannel, SRefCon inRefCon, short inPhonemeOpcode) {
    @autoreleasepool {
        ...
        [stw performSelectorOnMainThread:@selector(setExpressionForWord2:)
         //[[stw characterView] performSelectorOnMainThread:@selector(setExpressionForPhoneme:)
                              withObject:@(inPhonemeOpcode)
                           waitUntilDone:NO];
    }
...
static void OurPhonemeCallBackProcThree(SpeechChannel inSpeechChannel, SRefCon inRefCon, short inPhonemeOpcode) {
    @autoreleasepool {
        SpeakingTextWindow *stw = (__bridge SpeakingTextWindow *)inRefCon;
        //if ([stw shouldDisplayPhonemeCallbacks]) {
        [stw performSelectorOnMainThread:@selector(setExpressionForTextBox:)
         //[[stw characterView] performSelectorOnMainThread:@selector(setExpressionForPhoneme:)
                              withObject:@(inPhonemeOpcode)
                           waitUntilDone:NO];
    }
...
static void OurPhonemeCallBackProcFour(SpeechChannel inSpeechChannel, SRefCon inRefCon, short inPhonemeOpcode) {
    @autoreleasepool {
        SpeakingTextWindow *stw = (__bridge SpeakingTextWindow *)inRefCon;
        //if ([stw shouldDisplayPhonemeCallbacks]) {
        [stw performSelectorOnMainThread:@selector(setExpressionForTextBoxTwo:)
         //[[stw characterView] performSelectorOnMainThread:@selector(setExpressionForPhoneme:)
                              withObject:@(inPhonemeOpcode)
                           waitUntilDone:NO];
    }
